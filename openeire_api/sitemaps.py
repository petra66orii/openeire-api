...
class StaticPageSitemap(FrontendAbsoluteUrlSitemap):
    ...
    pages = (
        ...
        {"path": "/faq/art-prints", "priority": 0.6},
        {"path": "/faq/drone-footage-licensing", "priority": 0.6},
        {"path": "/faq/drone-footage-usage", "priority": 0.6},
        {"path": "/us/fine-art-prints", "priority": 0.7},
        {"path": "/us/wall-art-prints", "priority": 0.7},
        {"path": "/us/aerial-photography-prints", "priority": 0.7},
        {"path": "/us/landscape-wall-art", "priority": 0.7},
        {"path": "/us/large-wall-art", "priority": 0.7},
        {"path": "/us/wall-art-for-living-room", "priority": 0.7},
        {"path": "/us/wall-art-for-office", "priority": 0.7},
