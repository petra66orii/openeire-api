...
class SiteMetadataTests(TestCase):
    ...
    def test_static_sitemap_lists_indexable_frontend_pages(self):
        ...
        self.assertIn("https://openeire.ie/footage", content)
        self.assertIn("https://openeire.ie/faq", content)
        self.assertIn("https://openeire.ie/faq/art-prints", content)
        self.assertIn("https://openeire.ie/faq/drone-footage-licensing", content)
        self.assertIn("https://openeire.ie/faq/drone-footage-usage", content)
        self.assertIn("https://openeire.ie/blog", content)
        self.assertIn("https://openeire.ie/gallery/physical", content)
        self.assertIn("https://openeire.ie/us/fine-art-prints", content)
        self.assertIn("https://openeire.ie/us/wall-art-prints", content)
        self.assertIn("https://openeire.ie/us/aerial-photography-prints", content)
        self.assertIn("https://openeire.ie/us/landscape-wall-art", content)
        self.assertIn("https://openeire.ie/us/large-wall-art", content)
        self.assertIn("https://openeire.ie/us/wall-art-for-living-room", content)
        self.assertIn("https://openeire.ie/us/wall-art-for-office", content)
